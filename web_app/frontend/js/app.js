...
class OptimizationApp {
    ...
    initUI() {
        ...
        // 初始数据模式切换
        const initModeRadios = document.querySelectorAll('input[name="initMode"]');
        initModeRadios.forEach(radio => {
    ...
    async startOptimization() {
        ...
        // 获取初始数据模式
        const initModeRadio = document.querySelector('input[name="initMode"]:checked');
        const initMode = initModeRadio ? initModeRadio.value : 'auto';
